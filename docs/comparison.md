...
| **总计** | **100/120*** | **86/107** | **63/107** | **95/107** | **77/107** |
...
| **多模态** | 文本+图片 content blocks（OpenAI 兼容/native、Anthropic、Ollama 全映射），TUI 粘贴路径 + run --image，截图报错 Eval 3/3（P4-4） |
