...
| CLI/UI | 🟢 15/16* | 🟡 5/7 | 🟡 3/7 | 🟢 7/7 | 🟢 7/7 |
| 上下文管理 | 🟢 7/7 | 🟡 5/7 | 🟡 3/7 | 🟡 5/7 | 🟢 7/7 |
| 自改进 | 🟢 4/5 | 🔴 0/5 | 🔴 0/5 | 🟢 5/5 | 🔴 0/5 |
| 部署 | 🟢 7/8 | 🟢 6/8 | 🟡 3/8 | 🟢 7/8 | 🟡 4/8 |
| **总计** | **98/118*** | **86/107** | **63/107** | **95/107** | **77/107** |

🟢 ≥80% | 🟡 50-79% | 🔴 <50%

\* CLI/UI 行：Bounty 按 16 项口径计（P3-5 新增 6 项、P4-3 新增 3 项——后台长命令/run --json SDK/CI 示例——均已交付，桌面应用实验计半）；子代理行按 9 项口径计（P4-1 新增 DeVET 自动验签+可视化）；其余项目维持原口径未变，避免未经核实的评分。
