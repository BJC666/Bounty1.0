...
func (b *BrowserTool) Description() string {
	return "Control a headless Chrome browser (navigate, screenshot, extract, click, type)."
}
func (b *BrowserTool) Schema() json.RawMessage {
	return json.RawMessage(`{"type":"object","properties":{"action":{"type":"string","enum":["navigate","screenshot","content","click","type","start","stop"]},"url":{"type":"string","description":"URL (navigate)"},"selector":{"type":"string","description":"CSS selector"},"text":{"type":"string","description":"Text (type)"}},"required":["action"]}`)
}
