...
func (b *BrowserTool) Description() string {
	return "Drive a headless Chrome browser (navigate/screenshot/extract/click/type)."
}
func (b *BrowserTool) Schema() json.RawMessage {
	return json.RawMessage(`{"type":"object","properties":{"action":{"type":"string","enum":["navigate","screenshot","content","click","type","start","stop"]},"url":{"type":"string"},"selector":{"type":"string"},"text":{"type":"string"}},"required":["action"]}`)
}
